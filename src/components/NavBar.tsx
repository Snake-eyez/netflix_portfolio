...
import { FaBriefcase, FaTools, FaProjectDiagram, FaEnvelope } from 'react-icons/fa'; // Import icons
import './Navbar.css';
import netflixLogo from '../images/Derrel W.png';
    ...
    <>
      <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
        <div className="navbar-left">
          ...
          <ul className="navbar-links">
            ...
            <li><Link to="/products">Buy</Link></li>
      ...
      <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        ...
        <ul>
          ...
          <li><Link to="/products" onClick={closeSidebar}><FaProjectDiagram /> Buy</Link></li>
